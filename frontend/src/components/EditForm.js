  ...
  return (
    <div style={{ color: "white", marginTop: "3rem" }}>
      <div style={{ color: "white", fontSize: "1.7rem", fontWeight: "bold" }}>
        Edit Sensor: <span style={{ color: "rgb(222, 143, 83)" }}>{sensorId}</span>
      </div>
      <form
        style={{
          marginTop: "1.5rem",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "row", marginBottom: "1rem" }}>
          <label style={{ width: "12rem", fontWeight: "bold" }}>Sensor Id:</label>
          <Form.Control type="text" value={sensorId} onChange={(e) => setSensorId(e.target.value)} />
        </div>

        {/* Manufacturer */}
        <div style={{ display: "flex", flexDirection: "row", marginBottom: "1rem" }}>
          <label style={{ width: "12rem", fontWeight: "bold" }}>Manufacturer:</label>
        ...
        {/* Parameter */}
        <div style={{ display: "flex", flexDirection: "row", marginBottom: "1rem" }}>
          <label style={{ width: "12rem", fontWeight: "bold" }}>Parameter:</label>
          <Form.Control type="text" value={parameter} onChange={(e) => setParameter(e.target.value)} />
        </div>

        {/* Threshold */}
        <div style={{ display: "flex", flexDirection: "row", marginBottom: "1rem" }}>
          <label style={{ width: "12rem", fontWeight: "bold" }}>Threshold:</label>
          <Form.Control type="text" value={threshold} onChange={(e) => setThreshold(e.target.value)} />
        </div>
