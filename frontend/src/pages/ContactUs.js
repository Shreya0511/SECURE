...
const ContactUs = () => {
  return (
    ...
    <div style ={{ marginTop : "88vh",backgroundColor : "black", color : "white", display : "flex", padding : "1rem", width : "100vw",  overflowX : "hidden", flexDirection: "column"}}>
      ...
      <div style ={{display: "flex", justifyContent: "center", alignItems: "center", color : "gray", marginTop : "2rem", flexDirection: "column", marginBottom  : "2rem"}}><div>We will make every effort to contact you as soon as possible. Please ensure to check your registered email for any further updates.</div>
